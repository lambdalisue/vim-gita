...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_vim_gita#Vim#Buffer#Anchor#import() abort
  ...
  execute join(['function! vital#_vim_gita#Vim#Buffer#Anchor#import() abort', printf("return map({'focus': '', '_vital_depends': '', 'is_suitable': '', 'get_config': '', 'find_suitable': '', 'set_config': '', 'is_available': '', 'attach': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
